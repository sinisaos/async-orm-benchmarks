...
// The BaseUserFunc type is an adapter to allow the use of ordinary
// function as BaseUser mutator.
type BaseUserFunc func(context.Context, *ent.BaseUserMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f BaseUserFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.BaseUserMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.BaseUserMutation", m)
}

// The MegaTableFunc type is an adapter to allow the use of ordinary
// function as MegaTable mutator.
type MegaTableFunc func(context.Context, *ent.MegaTableMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f MegaTableFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.MegaTableMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.MegaTableMutation", m)
}
