...
type QuestionQuery struct {
	...
	withQuestionTags *QuestionTagQuery
...
func (_q *QuestionQuery) QueryBaseUser() *BaseUserQuery {
...
// QueryQuestionTags chains the current query on the "question_tags" edge.
func (_q *QuestionQuery) QueryQuestionTags() *QuestionTagQuery {
	query := (&QuestionTagClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *QuestionQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *QuestionQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *QuestionQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *QuestionQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *QuestionQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *QuestionQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *QuestionQuery) Clone() *QuestionQuery {
	...
	return &QuestionQuery{
		...
		withQuestionTags: _q.withQuestionTags.Clone(),
...
func (_q *QuestionQuery) WithBaseUser(opts ...func(*BaseUserQuery)) *QuestionQuery {
	query := (&BaseUserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithQuestionTags tells the query-builder to eager-load the nodes that are connected to
// the "question_tags" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *QuestionQuery) WithQuestionTags(opts ...func(*QuestionTagQuery)) *QuestionQuery {
	query := (&QuestionTagClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withQuestionTags = query
	return _q
}
...
func (_q *QuestionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Question, error) {
	...
	if query := _q.withBaseUser; query != nil {
		if err := _q.loadBaseUser(ctx, query, nodes, nil,
			func(n *Question, e *BaseUser) { n.Edges.BaseUser = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withQuestionTags; query != nil {
		if err := _q.loadQuestionTags(ctx, query, nodes,
			func(n *Question) { n.Edges.QuestionTags = []*QuestionTag{} },
			func(n *Question, e *QuestionTag) { n.Edges.QuestionTags = append(n.Edges.QuestionTags, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *QuestionQuery) loadAnswers(ctx context.Context, query *AnswerQuery, nodes []*Question, init func(*Question), assign func(*Question, *Answer)) error {
	...
	nodeids := make(map[uint]*Question)
	for i := range nodes {
...
func (_q *QuestionQuery) loadBaseUser(ctx context.Context, query *BaseUserQuery, nodes []*Question, init func(*Question), assign func(*Question, *BaseUser)) error {
...
func (_q *QuestionQuery) loadQuestionTags(ctx context.Context, query *QuestionTagQuery, nodes []*Question, init func(*Question), assign func(*Question, *QuestionTag)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint]*Question)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.QuestionTag(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(question.QuestionTagsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *QuestionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(question.Table, question.Columns, sqlgraph.NewFieldSpec(question.FieldID, field.TypeUint))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withBaseUser != nil {
			_spec.Node.AddColumnOnce(question.FieldUserID)
		}
	}
