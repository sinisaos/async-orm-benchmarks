...
func (_q *TagQuery) QueryQuestionTags() *QuestionTagQuery {
...
func (_q *TagQuery) WithQuestionTags(opts ...func(*QuestionTagQuery)) *TagQuery {
	query := (&QuestionTagClient{config: _q.config}).Query()
...
func (_q *TagQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Tag, error) {
	...
	if query := _q.withQuestionTags; query != nil {
		if err := _q.loadQuestionTags(ctx, query, nodes,
			func(n *Tag) { n.Edges.QuestionTags = []*QuestionTag{} },
			func(n *Tag, e *QuestionTag) { n.Edges.QuestionTags = append(n.Edges.QuestionTags, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *TagQuery) loadQuestionTags(ctx context.Context, query *QuestionTagQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *QuestionTag)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint]*Tag)
	for i := range nodes {
	...
	query.Where(predicate.QuestionTag(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tag.QuestionTagsColumn), fks...))
	}))
